...
class Config
{
    ...
    protected function mergeDefaultOptions($options)
    {
        ...
        $defaults = array(
            ...
            'tempDirectory' => '/Applications/XAMPP/xamppfiles/htdocs/aptech-php-16-namnh/php/12-2019-02-14/authentication/public/ckfinder/userfiles/temp/',
    ...
    protected function validate()
    {
        ...
        $requiredRootNodes = array(
            'authentication', 'licenseName', 'licenseKey', 'privateDir', 'images',
        ...
        foreach ($this->options['resourceTypes'] as $i => $resourceTypeConfig) {
            $checkMissingNodes(
                array('name', 'directory', 'maxSize', 'allowedExtensions', 'deniedExtensions', 'backend'),
                $resourceTypeConfig,
                "[resourceTypes][{$i}]"
            );
